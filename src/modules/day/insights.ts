 ...
 * docs/archive/design-adoption/day-design-adoption.md). No React, no fetching — same shape as
 ...
 * docs/reference/open-decisions.md): "happened" is exactly {completed tasks,
