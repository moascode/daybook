...
- Phases 0–6 of `docs/archive/option-2-workers-d1-plan.md` are complete and merged.
...
`docs/archive/option-2-workers-d1-plan.md` §4 always specified this as **Cloudflare edge
