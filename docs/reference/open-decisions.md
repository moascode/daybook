...
[cross-cutting/ai-usage.md](ai-usage.md)), D-15 task sharing
approved.
...
> **[cross-cutting/ai-usage.md](ai-usage.md)** — the single source
...
[foundation/04-e2e-and-migration.md](../archive/design-adoption/04-e2e-and-migration.md).
