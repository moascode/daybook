...
| R18 | **v3.6.0** | Machine capture — token auth, capture endpoint, pending inbox | ✅ **released 2026-09-07** — [spec](wallet/feature-capture-inbox.md); PRs [178](https://github.com/moascode/daybook/pull/178), [181](https://github.com/moascode/daybook/pull/181)–[184](https://github.com/moascode/daybook/pull/184). PR-6 (shortcut clients + setup guide) still open, blocked on the Gate 0 on-device probe |
