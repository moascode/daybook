...
(recurring anomalies) and FEAT-018 (budget suggestions, shipped 2026-09-19)
were the two that change behaviour rather than just displaying it — build
FEAT-021 next of what remains for that reason.
...
| [FEAT-018](../../archive/ep-06-wallet-depth/FEAT-018-budgets-suggestions.md) | Budgets: suggestions engine | [PR #214](https://github.com/moascode/daybook/pull/214)/[#215](https://github.com/moascode/daybook/pull/215)/[#216](https://github.com/moascode/daybook/pull/216), 2026-09-19 |
