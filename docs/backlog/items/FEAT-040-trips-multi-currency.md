...
# FEAT-040 — Trips: multi-currency

**What.** Per-transaction exchange rate; local currency leads in Trips, home currency leads in Wallet; a rate card separating FX overrun from choice overrun.
