...
# FEAT-037 — Trips: phase-aware prep readiness

**What.** A prep view whose readiness reflects how close the trip is.

**Why now.** A checklist that does not know the trip is tomorrow is just a list.
