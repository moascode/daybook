...
|---|---|---|
| [FEAT-001](FEAT-001-business-foundation.md) | Business schema + routes foundation | Only if the epic proceeds |
| [FEAT-002](FEAT-002-invoice-editor.md) | Invoice editor with live preview and print | **The high-value piece** |
| [FEAT-003](FEAT-003-customers-products.md) | Customers and products CRUD | Only if the epic proceeds |
| [FEAT-004](FEAT-004-purchases-sales.md) | Purchases and sales ledgers | ⚠️ Overlaps Wallet transactions — question this one first |
| [FEAT-005](FEAT-005-business-dashboard.md) | Business summary dashboard | ⚠️ Overlaps the Wallet dashboard |
