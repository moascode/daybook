...
|---|---|---|
| [FEAT-011](FEAT-011-non-mutating-fetch.md) | Non-mutating `fetchTransactions` variant | Yes |
| [FEAT-012](FEAT-012-batch-delete-transactions.md) | Batch `DELETE /transactions` endpoint | Yes |
| [FEAT-013](FEAT-013-centralise-date-formatting.md) | Centralise `formatDisplayDate` | Yes — 15+ inline copies |
| [FEAT-014](FEAT-014-fold-split-dialog.md) | Fold `SplitDialog` into the bulk path | Question it — it may be earning its place |
