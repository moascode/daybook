...
[FEAT-044](../items/FEAT-044-day-close-the-day.md), Close the day. If that
...
just [FEAT-045](../items/FEAT-045-day-usual-and-on-this-day.md), which is a pure
read over existing data and cheap on its own.

One schema change: [FEAT-041](../items/FEAT-041-day-hour-ribbon.md) needs
...
|---|---|---|
| [FEAT-041](../items/FEAT-041-day-hour-ribbon.md) | Real time-of-day and the hour ribbon | Yes — foundation, needs D-6 |
| [FEAT-042](../items/FEAT-042-day-notes.md) | Notes as timeline entries | Yes |
| [FEAT-043](../items/FEAT-043-day-composer.md) | Composer writing to either module | Yes — reuses R7's composer |
| [FEAT-044](../items/FEAT-044-day-close-the-day.md) | Close the day | **The whole point of the epic** — decide this first |
| [FEAT-045](../items/FEAT-045-day-usual-and-on-this-day.md) | Against your usual, On this day | Yes — cheap, standalone |
| [FEAT-046](../items/FEAT-046-day-month-grid.md) | Month grid, This week, Calendar, Weekly review | Yes |
