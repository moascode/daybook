...
|---|---|---|
| [BUG-002](../items/BUG-002-impossible-calendar-dates.md) | ISO validation accepts Feb 30 / Apr 31 | **Yes** — silently relocates a transaction to another day |
| [BUG-003](../items/BUG-003-day-header-split-totals.md) | Day headers may double-count splits | **Yes** — and the first step is confirming whether it's real |

> Both are also listed in the design-adoption plan as things a public `v4.0.0`
> should not ship without ([EP-10](EP-10-cross-cutting.md)). They are tracked
