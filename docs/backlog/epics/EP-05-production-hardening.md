...
|---|---|---|
| [BUG-001](../items/BUG-001-no-rate-limiting.md) | No rate limiting on the public URL | **Yes** — highest-severity item in the backlog |
| [BUG-004](../items/BUG-004-e2e-account-residue.md) | `e2e_*` account residue on the retired Mac | Consider dropping — the live D1 database is clean |
