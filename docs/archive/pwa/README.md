...
| [splash-generation.md](../../guides/splash-generation.md) | How the iOS launch images are made, and how to add a device |
| [push-setup.md](../../guides/push-setup.md) | The one-time VAPID secret setup, and what arrives when |
...
| P4 | Push notifications — six digests, two daily slots | ✅ merged — **needs [two secrets set](../../guides/push-setup.md)** before it does anything |
| P5 | Themed splash screens | ✅ merged — see [splash-generation.md](../../guides/splash-generation.md) |
