...
| Doc | What it covers |
|---|---|
| [01-data-model.md](../../backlog/EP-09-day-module/data-model.md) | time of day, notes, and the interim |
| [02-design-adoption.md](day-design-adoption.md) | R6 — the route and the honest first timeline |
| [03-feature-waves.md](../../backlog/EP-09-day-module/design.md) | R15–R16 — the real page and the ritual |
