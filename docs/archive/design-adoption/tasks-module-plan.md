...
| Doc | What it covers |
|---|---|
| [01-data-model.md](tasks-data-model.md) | R4 — the migration and API that make R5 renderable |
| [02-design-adoption.md](tasks-design-adoption.md) | R5 — Today, All tasks, List detail, Completed |
| [03-feature-waves.md](../../backlog/EP-07-tasks-depth/design.md) | R10–R11 — Upcoming, Assigned, Habits, insights |
