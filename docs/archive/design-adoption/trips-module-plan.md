...
[01-data-model.md](../../backlog/EP-08-trips-module/data-model.md) reconstructs what they imply.

| Doc | What it covers |
|---|---|
| [01-data-model.md](../../backlog/EP-08-trips-module/data-model.md) | schema, and the ownership rule |
| [02-design-adoption.md](trips-design-adoption.md) | R6 — the tab, the route, the January state |
| [03-feature-waves.md](../../backlog/EP-08-trips-module/design.md) | R12–R14 — the real module |

Decisions (both resolved 2026-08-21): **D-4** → module; **D-5** → full multi-currency. See [../open-decisions.md](../../reference/open-decisions.md).
