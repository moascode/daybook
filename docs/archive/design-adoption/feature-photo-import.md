...
as **P2** in [../cross-cutting/ai-usage.md](../../reference/ai-usage.md) —
...
2. **CSV gets the same modal, not just photo.** The old doc scoped itself to
   ...
   note in `docs/roadmap/design-adoption/wallet/README.md`-adjacent PR description for the CSV
...
([ai-usage.md](../../reference/ai-usage.md) §3 rule 4), and every other AI
...
## 4. The two prompts (Haiku, per [ai-usage.md](../../reference/ai-usage.md) rule 1)
