...
[open-decisions.md](../../reference/open-decisions.md) (what is not yet decided). Decisions
...
Spec: [foundation/01-design-tokens.md](01-design-tokens.md),
[foundation/02-component-layer.md](02-component-layer.md),
...
Spec: [foundation/03-app-shell.md](03-app-shell.md).
...
Spec: [wallet/02-design-adoption.md](wallet-design-adoption.md).
...
Spec: [tasks/01-data-model.md](tasks-data-model.md). **Blocking: none — D-3 (keep outliner) and D-15 (task sharing) both resolved 2026-08-21.**
...
Spec: [tasks/02-design-adoption.md](tasks-design-adoption.md).
...
Specs: [trips/02-design-adoption.md](trips-design-adoption.md),
[day/02-design-adoption.md](day-design-adoption.md).
...
Spec: [wallet/03-feature-waves.md](../../backlog/EP-06-wallet-depth/design.md).
...
Spec: [tasks/03-feature-waves.md](../../backlog/EP-07-tasks-depth/design.md).
...
Spec: [trips/03-feature-waves.md](../../backlog/EP-08-trips-module/design.md).
...
Spec: [day/03-feature-waves.md](../../backlog/EP-09-day-module/design.md).

## R18 · **`v3.6.0`** · Machine capture: token auth + pending inbox

Spec: [wallet/feature-capture-inbox.md](feature-capture-inbox.md).
...
Spec: [cross-cutting/README.md](../../backlog/EP-10-cross-cutting/design.md).
