...
| Doc | What it covers |
|---|---|
| [02-design-adoption.md](wallet-design-adoption.md) | R3 — the eight pages, page by page |
| [03-feature-waves.md](../../backlog/EP-06-wallet-depth/design.md) | R7–R9 — what the design shows that we do not compute |
