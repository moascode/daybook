...
ending in its own PR. Point Claude Code at this file (`docs/archive/business-module-plan.md`
...
`docs/archive/business-module-invoice-reference.pdf` (placed alongside this file)
...
1. Point Claude Code at `CLAUDE.md` and `docs/archive/business-module-plan.md` and
...
```
Read CLAUDE.md in full, then read docs/archive/business-module-plan.md in full.
...
```
Read CLAUDE.md and docs/archive/business-module-plan.md first (foundation from
...
```
Read CLAUDE.md and docs/archive/business-module-plan.md first, especially §7
(Invoices) and the attached docs/archive/business-module-invoice-reference.pdf.
