...
> `docs/archive/option-2-workers-d1-plan.md` §3.
...
estimate of `docs/archive/option-2-workers-d1-plan.md`.
...
Two adjustments to `docs/archive/option-2-workers-d1-plan.md` §6, roughly cancelling out:
