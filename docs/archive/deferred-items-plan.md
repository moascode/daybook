...
**Context:** The multi-model adversarial review (`docs/archive/adversarial-review-2026-07-20.md`)
...
item traces back to a finding ID in `docs/archive/adversarial-review-2026-07-20.md`.*
