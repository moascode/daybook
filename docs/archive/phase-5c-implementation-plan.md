...
> **Status:** Approved 2026-07-05. Companion to `docs/archive/phase-5c-wallet-ux.md` (the backlog
...
- **D1–D6** — each needs individual owner sign-off; see `docs/archive/phase-5c-wallet-ux.md` §D.
