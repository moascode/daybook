...
> below is either measured (see `docs/archive/option-2-spike-findings.md`) or derived
...
`docs/archive/option-2-spike-findings.md`; here is what each one changed about this plan.
...
**1. Blocker 4.1 disappears.** `docs/archive/phase-6-online-plan.md` §4.1 flags the
...
The public-exposure blockers from `docs/archive/phase-6-online-plan.md` §4, translated:
...
**Next step if no:** `docs/archive/phase-6-online-plan.md` §3 has Options 1 and 3 costed
