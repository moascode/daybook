...
A full user guide with screenshots and feature walkthroughs is planned. See `docs/archive/USER-GUIDE.md` (to be created in Phase 5 when the AI features are added and the UX is stable enough to document).
