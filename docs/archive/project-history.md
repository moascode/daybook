...
> on 2026-09-02, and `v2.10.0`/`v2.11.0` do not exist. `docs/roadmap/design-adoption/release-plan.md`
...
docs/archive/ai-bulk-categorize-feature.md in one PR (not the doc's
...
2026-08-08) — see docs/archive/ai-bulk-categorize-feature.md §8.
...
docs/archive/shared-review-implementation-plan.md. 500/500 e2e under
...
docs/archive/split-settlement-plan.md, all six waves merged.
...
docs/archive/option-2-spike-findings.md.
...
(docs/archive/option-2-workers-d1-plan.md). Owner chose Option 2 on
...
docs/archive/phase-5c-implementation-plan.md (approved 2026-07-05).
Backlog detail: docs/archive/phase-5c-wallet-ux.md (statuses updated:
...
docs/archive/deferred-items-plan.md are now DONE on branch
...
docs/archive/phase-6-online-plan.md. Owner constraints: 2 active
...
> Session label was "R4" at the time — do not confuse with `docs/roadmap/design-adoption/README.md`'s
> R4 (Tasks schema bump), a same-named but unrelated release in the v2
> design-adoption plan. This work is on the older docs/archive/flow-plan.md track
> (PR #112's follow-up), not the v2 roadmap.

Completed the follow-up to PR #112: a resolution ladder for CSV-import
merchant names, per docs/archive/flow-plan.md. Regex guess -> `merchant_corrections`
